...
int main(int argc, char** argv){
    ...
    rect_img_left_publisher = nh.advertise<sensor_msgs::Image>("/vid_rectify/rectified_front_left_images", 10);
    rect_img_right_publisher = nh.advertise<sensor_msgs::Image>("/vid_rectify/rectified_front_right_images", 10);
